            ...
            <div className="text-black my-12">
                <div className="container max-w-4xl px-10 py-6 mx-auto">
                    <div className="mt-3 border-2 p-4 border-orange-200 shadow-lg rounded-lg">
                        <h5 className="text-3xl font-bold hover:underline">1. What are the different ways to manage a state in a React application?</h5>
                    ...
                    <div className="mt-3  border-2 p-4 border-orange-200 shadow-lg rounded-lg">
                        <h2 className="text-3xl font-bold hover:underline">2. How does prototypical inheritance work?</h2>
                        <p className="mt-2">The Prototypal Inheritance is a feature in javascript used to add methods and properties in objects. It is a method by which an object can inherit the properties and methods of another object. Traditionally, in order to get and set the [[Prototype]] of an object, we use Object.getPrototypeOf and Object.</p>
                    </div>
                    <div className='mt-3 border-2 p-4 border-orange-200 shadow-lg rounded-lg'>
                        <h5 className='text-3xl font-bold hover:underline'>3. What is a unit test? Why should we write unit tests?</h5>
                        <p className='px-5'>
                ...
                <div className="mt-3  border-2 p-4 border-orange-200 shadow-lg rounded-lg">
                    <h2 className='text-3xl font-bold hover:underline'>4. React vs. Angular vs. Vue?</h2>
