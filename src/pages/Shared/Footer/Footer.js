...
const Footer = () => {
    return (
        <footer className="px-4 py-4 bg-[#256D85] text-white mt-4">
            <div className="container flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between sm:space-y-0">
                ...
                <ul className="flex flex-wrap pl-3 space-x-4 font-bold">
                    <li>
            ...
            <p className='text-white text-center mt-4'>&copy; {(new Date().getFullYear())} All Rights Reserved. </p>
        </footer>
